...
const RegisterForm = () => {
    const [formInputValidity, setFormInputsValidity] = useState({
      ...
      const submitHandler = (event) => {
        ...
        const formIsValid =
            enteredFirstName && enteredLastName && enteredAddress && enteredCity &&
            enteredPhoneNumber && enteredEmail && enteredPassword;
        ...
        const lastNameControlClasses = `${styles.control} ${formInputValidity.lastName ? "" : styles.invalid}`
        ...
        const phoneNumberControlClasses = `${styles.control} ${formInputValidity.phoneNumber ? "" : styles.invalid}`;
        const emailControlClasses = `${styles.control} ${formInputValidity.email ? "" : styles.invalid}`
        const passwordControlClasses = `${styles.control} ${formInputValidity.password ? "" : styles.invalid}`
